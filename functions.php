...
if ( ! function_exists( 'webuild_setup' ) ) :
/**
...
function webuild_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'webuild' ),
	) );
 ...
 */
function webuild_register_custom_background() {
	$args = array(
		'default-color' => 'ffffff',
		'default-image' => '',
	);

	$args = apply_filters( 'webuild_custom_background_args', $args );
...
add_action( 'after_setup_theme', 'webuild_register_custom_background' );
...
function webuild_scripts() {
	wp_enqueue_style( 'WeBuild-style', get_stylesheet_uri() );

	wp_deregister_script( 'jquery' );
	wp_register_script( 'jquery', 'http://cdnjs.cloudflare.com/ajax/libs/jquery/2.0.0/jquery.min.js', array(), false, true);
